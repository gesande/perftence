...
public final class ImageFactoryUsingAFreeChart implements ImageFactory {
    private static final Logger LOGGER = LoggerFactory.getLogger(ImageFactoryUsingAFreeChart.class);
    ...
    public ImageFactoryUsingAFreeChart(final ChartColors colors, final ChartWriter<AFreeChart> writer) {
        this.colors = colors;
        this.writer = writer;
    ...
    public void createXYLineChart(final String id, final ImageData imageData) {
        ...
        final LineChartGraphData mainData = lineChartGraphData(imageData, gray());
    ...
    private LineGraphStatisticsGraphData statistics(final ImageData imageData,
        ...
        final LineChartGraphData average = data.newSeries("Median", green(), lineChartGraphData.range());
        final LineChartGraphData percentile95 = data.newSeries("95 percentile", cyan(), lineChartGraphData.range());
        final LineChartGraphData mean = data.newSeries("Mean", red(), lineChartGraphData.range());
    ...
    private static BarChartGraphData barGraphData(final ImageData imageData, PaintType paint) {
    ...
    @SuppressWarnings("unchecked")
    private static LineChartGraphData lineChartGraphData(final ImageData imageData, final PaintType paint) {
    ...
    final class LineGraphStatisticsGraphData {
        ...
        LineChartGraphData newSeries(final String title, final PaintType paint, Range range) {

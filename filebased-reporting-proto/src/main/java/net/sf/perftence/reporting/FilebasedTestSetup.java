...
public class FilebasedTestSetup implements Serializable {
    ...
    public FilebasedTestSetup(final PerformanceTestSetup testSetup, final boolean includeInvocationGraph) {
    ...
    private void readObject(final java.io.ObjectInputStream in) throws IOException, ClassNotFoundException {
        ...
        this.testSetup = (PerformanceTestSetup) readFields.get("testSetup", null);
        this.includeInvocationGraph = readFields.get("includeInvocationGraph", true);
    }

...
final class DistributedTestRuntimeReporter implements TestRuntimeReporter {
    ...
    public DistributedTestRuntimeReporter(final TestRuntimeReporter localReporter,
            final ExecutorService executorService, final LatencyReporter... remoteLatencyReporters) {
        this.reporter = localReporter;
        this.executorService = executorService;
        this.remoteReporters = new ArrayList<>(Arrays.asList(remoteLatencyReporters));
    }

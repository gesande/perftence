...
public final class ImageData {
    ...
    private ImageData(final String title, final String xAxisTitle, final double range,
            final GraphStatisticsProvider statistics, final DatasetAdapter<?, ?> adapter) {
        this.title = title;
    ...
    public static ImageData statistics(final String title, final String xAxisTitle, final double range,
            final GraphStatisticsProvider statistics, final DatasetAdapter<?, ?> adapter) {
        return new ImageData(title, xAxisTitle, range, statistics, adapter);
    }

    public static ImageData noStatistics(final String title, final String xAxisTitle, final double range,
            final DatasetAdapter<?, ?> adapter) {
        return new ImageData(title, xAxisTitle, range, null, adapter);
    }

    public static ImageData noStatistics(final String title, final String xAxisTitle,
            final DatasetAdapter<?, ?> adapter) {

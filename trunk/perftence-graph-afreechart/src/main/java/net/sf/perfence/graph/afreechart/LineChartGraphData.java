...
public final class LineChartGraphData implements GraphData<LineChartGraphData, Range, PaintType> {
    ...
    LineChartGraphData(final String title, final PaintType paint, final XYSeries series) {
        this.series = series;
        this.paint = paint;
        this.title = title;
    }

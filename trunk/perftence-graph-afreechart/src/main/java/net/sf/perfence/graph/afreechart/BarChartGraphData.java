...
final class BarChartGraphData implements GraphData<BarChartGraphData, Range, PaintType> {
    ...
    BarChartGraphData(final String title, final PaintType paintType, final CategoryDataset categoryDataset) {
        this.title = title;

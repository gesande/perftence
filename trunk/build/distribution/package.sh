...
build-packages() {
  gradle clean perftence-bag:test perftence:test responsecode-summaryappender:test perftence-junit-utils:test perftence-classhelper:test perftence-linereader:test perftence-junit:test acceptance-tests:test

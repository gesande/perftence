...
public class SummaryFieldFactory implements CustomSummaryFieldProvider {
	...
	public static SummaryFieldFactory create(
			final FieldFormatter fieldFormatter,
			final FieldAdjuster fieldAdjuster) {
		return new SummaryFieldFactory(fieldFormatter, fieldAdjuster);
	}

	private SummaryFieldFactory(final FieldFormatter fieldFormatter,
			final FieldAdjuster fieldAdjuster) {
	...
	static FieldDefinition adjustedFieldName(final FieldDefinition def,
			final FieldAdjuster fieldAdjuster) {
	...
	public SummaryFieldBuilder<Long> max() {
		return new SummaryFieldBuilderForSingleValue<Long>(fieldFormatter(),
				fieldAdjuster()).field(Fields.Max);
	}

	public SummaryFieldBuilder<Integer> threads() {
		return new SummaryFieldBuilderForSingleValue<Integer>(fieldFormatter(),
				fieldAdjuster()).field(Fields.Threads);
	}

	public SummaryFieldBuilder<Long> executionTime() {
		return new SummaryFieldBuilderForSingleValue<Long>(fieldFormatter(),
				fieldAdjuster()).field(Fields.ExecutionTime);
	}

	public SummaryFieldBuilder<Double> throughput() {
		return new SummaryFieldBuilderForSingleValue<Double>(fieldFormatter(),
				fieldAdjuster()).field(Fields.Throughput);
	}

	public SummaryFieldBuilder<Long> percentile95() {
		return new SummaryFieldBuilderForSingleValue<Long>(fieldFormatter(),
				fieldAdjuster()).field(Fields.Percentile95);
	}

	public SummaryFieldBuilder<Long> median() {
		return new SummaryFieldBuilderForSingleValue<Long>(fieldFormatter(),
				fieldAdjuster()).field(Fields.Median);
	}

	public SummaryFieldBuilder<Double> average() {
		return new SummaryFieldBuilderForSingleValue<Double>(fieldFormatter(),
				fieldAdjuster()).field(Fields.Average);
	}

	public EstimatedTimeLeftBasedOnDuration estimatedTimeLeftBasedOnDuration() {
		return EstimatedTimeLeftBasedOnDuration.create(fieldFormatter(),
				fieldAdjuster());
	}
	...
	public static class EstimatedTimeLeftBasedOnDuration extends
		...
		private EstimatedTimeLeftBasedOnDuration(
				final FieldFormatter fieldFormatter,
		...
		public static EstimatedTimeLeftBasedOnDuration create(
				final FieldFormatter fieldFormatter,
				final FieldAdjuster fieldAdjuster) {
		...
		public EstimatedTimeLeftBasedOnDuration actualTimeLeft(
				final long actualTimeLeft) {
			this.actualTimeLeft = actualTimeLeft;
			return this;
		}

		public SummaryField<String> estimatedTimeLeft(
				final double estimatedTimeLeft) {
		...
		public String value() {
			return new StringBuilder()
					.append(actualTimeLeft() <= 0 ? "less than " : "")
					.append(format(estimatedTimeLeft())).append(" (sec)")
					.toString();
		}
	...
	public EstimatedTimeLeftBasedOnThroughput estimatedTimeLeftBasedOnThroughput() {
		return EstimatedTimeLeftBasedOnThroughput.create(fieldFormatter(),
				fieldAdjuster());
	}
}
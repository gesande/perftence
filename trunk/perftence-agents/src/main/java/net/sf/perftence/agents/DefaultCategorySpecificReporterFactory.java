...
final class DefaultCategorySpecificReporterFactory implements CategorySpecificReporterFactory {
    ...
    @Override
    public InvocationReporterAdapter adapterFor(final ReporterFactoryForCategorySpecificLatencies reporterFactory,
            final TestTaskCategory category) {
        final LatencyProvider latencyProvider = latencyProviderFactory().newInstance();

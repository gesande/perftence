...
class StatisticsSummaryProviderUsingStatisticsProviderStatistics implements StatisticsSummaryProvider<HtmlSummary> {

    private final StatisticsProvider statistics;

    public StatisticsSummaryProviderUsingStatisticsProviderStatistics(final StatisticsProvider statistics) {
    ...
    public void provideSummary(final HtmlSummary summary) {
        ...
        summary.averageResponseTime(statistics().averageLatency(), " ms").endOfLine();
    ...
    @Override
    public StatisticsSummaryProviderUsingStatisticsProviderStatistics elapsedTime(final long elapsedTime) {
        return this;
    }

    @Override
    public StatisticsSummaryProviderUsingStatisticsProviderStatistics invocations(final long invocationCount) {
        return this;
    }

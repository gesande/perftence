...
final class StatisticsSummaryProviderUsingDefaultInvocationStorageStatistics
    ...
    public StatisticsSummaryProviderUsingDefaultInvocationStorageStatistics(final InvocationStorage storage) {
    ...
    public void provideSummary(final HtmlSummary summary) {
        ...
        summary.throughput(stat.throughput(elapsedTime(), invocationCount())).endOfLine();
    ...
    @Override
    public StatisticsSummaryProviderUsingDefaultInvocationStorageStatistics elapsedTime(long elapsedTime) {
        this.elapsedTime = elapsedTime;
        return this;
    }

    @Override
    public StatisticsSummaryProviderUsingDefaultInvocationStorageStatistics invocations(long invocations) {

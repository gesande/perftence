...
public final class DefaultThroughputStorage implements ThroughputStorage {
    ...
    public DefaultThroughputStorage(final int range, final LineChartAdapterProvider<?, ?> lineChartAdapterProvider) {
        this.range = range;
    ...
    @Override
    public synchronized void store(final long currentDuration, final double throughput) {
    ...
    public ImageData imageData() {
        ...
        final ImageData imageData = ImageData.noStatistics("Throughput over time", "Time elapsed", range(),

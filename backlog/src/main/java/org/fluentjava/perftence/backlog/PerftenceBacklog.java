...
import static org.fluentjava.perftence.backlog.PerftenceTag.backlog;
import static org.fluentjava.perftence.backlog.PerftenceTag.build;
import static org.fluentjava.perftence.backlog.PerftenceTag.codeQuality;
import static org.fluentjava.perftence.backlog.PerftenceTag.deployment;
import static org.fluentjava.perftence.backlog.PerftenceTag.development;
import static org.fluentjava.perftence.backlog.PerftenceTag.developmentSupport;
import static org.fluentjava.perftence.backlog.PerftenceTag.feature;
import static org.fluentjava.perftence.backlog.PerftenceTag.ide;
import static org.fluentjava.perftence.backlog.PerftenceTag.infrastructure;
import static org.fluentjava.perftence.backlog.PerftenceTag.refactoring;
...
public class PerftenceBacklog extends AbstractBacklogging {
	...
	public void show() {
		newBacklog().title("Backlog for pertence test tool:").done().title("DONE:").tasks(
				...
				done("net.sf -> org.fluentjava", refactoring))

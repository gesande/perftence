...
public class BacklogWaitingForImplementation {
	...
	private static class WaitingForImplementation implements BacklogFactory {
		...
		public WaitingForImplementation(final BacklogDisplay display, final List<Tag> waitingTags) {
		...
		public static BacklogFactory displayedBy(final BacklogDisplay display, final List<Tag> waitingTags) {

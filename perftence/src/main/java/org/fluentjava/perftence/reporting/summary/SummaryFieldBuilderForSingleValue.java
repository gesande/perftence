...
public final class SummaryFieldBuilderForSingleValue<T> implements SummaryFieldBuilder<T>, BuildableSummaryField<T> {
    ...
    SummaryFieldBuilderForSingleValue(final FieldFormatter fieldFormatter, final FieldAdjuster fieldAdjuster) {
        this.fieldFormatter = fieldFormatter;
        this.fieldAdjuster = fieldAdjuster;
    }

    SummaryFieldBuilderForSingleValue<T> field(final FieldDefinition fieldDefinition) {
    ...
    public SummaryField<String> asFormatted() {
        return new SummaryFieldImpl<>(adjustedFieldName(), value() == null ? "<value was null>" : format(value()));
    }

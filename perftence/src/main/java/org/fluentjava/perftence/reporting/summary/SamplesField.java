...
public final class SamplesField extends SummaryFieldImpl<String> {
    ...
    static SamplesField create(final FieldAdjuster fieldAdjuster) {
        return new SamplesField(SummaryFieldFactory.adjustedFieldName(Fields.Samples, fieldAdjuster));
    }
    ...
    @Override
    public String value() {
        return new StringBuilder().append(samplesSoFar()).append("/").append(samplesTotal()).toString();
    }

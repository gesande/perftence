...
public final class LastSecondFailures implements CustomFailureReporter, CustomIntermediateSummaryProvider {
    ...
    public LastSecondFailures(final FailedInvocationsFactory failedInvocationsFactory) {
    ...
    public synchronized void more(final Throwable t) {
        ...
        if (failures().containsKey(currentSecond)) {
            ...
            final FailedInvocations failed = failedInvocationsFactory().newInstance();
            failed.more(t);

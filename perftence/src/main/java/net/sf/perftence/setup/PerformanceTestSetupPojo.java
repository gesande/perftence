...
public final class PerformanceTestSetupPojo implements PerformanceTestSetup, Serializable {
    ...
    public static class PerformanceTestSetupBuilder {
         ...
         */
        public PerformanceTestSetupBuilder invocationRange(final int invocationRange) {
         ...
         */
        public PerformanceTestSetupBuilder throughputRange(final int throughputRange) {
            this.throughputRange = throughputRange;
            return this;
        }

        public PerformanceTestSetup build() {
            return new PerformanceTestSetupPojo(this.threads, this.invocations, this.duration, this.invocationRange,
                    this.throughputRange, this.summaryAppenders, this.graphWriters);
        }

        public PerformanceTestSetupBuilder summaryAppender(final SummaryAppender... summaryAppenders) {
        ...
        public PerformanceTestSetupBuilder graphWriter(final GraphWriter... graphWriters) {
        ...
        public PerformanceTestSetup noSetup() {
            return new PerformanceTestSetup() {
                ...
                private RuntimeException noTestSetupDefined() {
                    return new NoTestSetupDefined("No test setup has been defined!");
                }
            };
        }
    }
    ...
    private PerformanceTestSetupPojo(final int threads, final int invocations, final int duration,
            final int invocationRange, final int throughputRange, final Collection<SummaryAppender> summaryAppenders,
    ...
    public String toString() {
        return "PerformanceTestSetupPojo [threads=" + this.threads + ", invocations=" + this.invocations + ", duration="
                + this.duration + ", invocationRange=" + this.invocationRange + ", throughputRange="
                + this.throughputRange + ", summaryAppenders=" + this.summaryAppenders + ", graphWriters="
                + this.graphWriters + "]";
    }
}
